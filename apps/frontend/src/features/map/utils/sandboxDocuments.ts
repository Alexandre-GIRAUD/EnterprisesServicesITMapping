...
export const SANDBOX_ICON_PALETTE: SandboxIconDef[] = [
  ...
  // Teams — person + color (unique keys, searchable)
  { key: '🧍🔴', label: 'Team — Red', keywords: 'team people person red' },
  { key: '🧍🔵', label: 'Team — Blue', keywords: 'team people person blue' },
  { key: '🧍🟢', label: 'Team — Green', keywords: 'team people person green' },
  { key: '🧍🟡', label: 'Team — Yellow', keywords: 'team people person yellow' },
  { key: '🧍🟠', label: 'Team — Orange', keywords: 'team people person orange' },
  { key: '🧍🟣', label: 'Team — Purple', keywords: 'team people person purple' },
  { key: '🧍⚫', label: 'Team — Black', keywords: 'team people person black' },
  { key: '🧍⚪', label: 'Team — White', keywords: 'team people person white' },
  // Contributors — hand + color
  { key: '✋🔴', label: 'Contributor — Red', keywords: 'contributor hand people red' },
  { key: '✋🔵', label: 'Contributor — Blue', keywords: 'contributor hand people blue' },
  { key: '✋🟢', label: 'Contributor — Green', keywords: 'contributor hand people green' },
  { key: '✋🟡', label: 'Contributor — Yellow', keywords: 'contributor hand people yellow' },
  { key: '✋🟠', label: 'Contributor — Orange', keywords: 'contributor hand people orange' },
  { key: '✋🟣', label: 'Contributor — Purple', keywords: 'contributor hand people purple' },
  { key: '✋⚫', label: 'Contributor — Black', keywords: 'contributor hand people black' },
  { key: '✋⚪', label: 'Contributor — White', keywords: 'contributor hand people white' },
  { key: '🤝', label: 'Handshake', keywords: 'deal partner agreement contributor' },
  { key: '👋', label: 'Wave', keywords: 'contributor hand hello' },
  { key: '🖐️', label: 'Hand', keywords: 'contributor hand open' },
  { key: '🤚', label: 'Raised hand', keywords: 'contributor hand raised' },
  ...
  { key: '💵', label: 'Banknote', keywords: 'cash dollar finance money' },
  { key: '💴', label: 'Yen', keywords: 'cash currency finance money' },
  { key: '💶', label: 'Euro', keywords: 'cash currency finance money' },
  { key: '💷', label: 'Pound', keywords: 'cash currency finance money' },
  ...
  { key: '💲', label: 'Dollar sign', keywords: 'finance money cost price' },
