---
name: awwwards
description: Apply Awwwards-winning design principles. Use when designing UIs,
  creating frontends, or improving visual design. Triggers on frontend design,
  UI/UX work, styling, CSS, component design.
---
